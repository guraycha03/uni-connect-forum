...
const HomePage = () => {
  ...
  return (
    <main className="min-h-screen bg-gray-100">
      ...
      {/* Welcome Section */}
      <motion.div
        className="max-w-5xl mx-auto px-6 py-12 -mt-24 relative z-10 bg-white rounded-2xl shadow-lg border border-maroon-200"
      ...
      <section className="bg-maroon-50 py-16 px-6">
        <div className="max-w-4xl mx-auto bg-white border border-maroon-100 shadow-md rounded-xl p-8">
