...
// Dynamically import DashboardChart (to avoid server-side rendering issues)
  ...
  return (
    <main className="p-6 bg-maroon-100 min-h-screen">
      ...
      <section className="bg-white rounded-lg shadow-md p-6 min-h-[500px]" aria-labelledby="campus-stats">
        ...
        {/* Pass the correct props to DashboardChart */}
        <DashboardChart
          studentCount={students.length} // ✅ Correct prop name
