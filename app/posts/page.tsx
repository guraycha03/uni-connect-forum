...
import { User, Users, FileText, MessageCircle, BarChart as ChartIcon, PlusCircle, Trash2, Edit, Send } from 'lucide-react';
...
//const initialPostsData = [ // Define a single initial post
//    {
//        id: 1,
...
//        author: `Professor Johnson`, // More realistic author
...
//        ],
//    },
//    ...generateMockPostData(2) // Start with fewer posts for a cleaner look
//];
const initialCommentsData = generateMockCommentData(0);
...
const ChartPanel = () => {
    ...
    useEffect(() => {
        ...
        updateChartData(posts, initialCommentsData);
    }, [posts]);
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="shadow-lg border-0 col-span-full md:col-span-2">
                <CardHeader>
            ...
            <Card className="shadow-lg border-0 col-span-full md:col-span-1">
                <CardHeader>
                    <CardTitle className="flex items-center gap-2">
...
const PostsPage = () => {
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-3xl font-bold text-gray-800 mb-6">Posts and Data Overview</h1>
            <ChartPanel />
        </div>
    );
};
